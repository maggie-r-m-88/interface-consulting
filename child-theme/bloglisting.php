...
<div class="blog_post_preview format-<?php echo esc_attr($pf); ?>">
    <div class="item_wrapper">
        <div class="blog_content">
            ...
            <?php
            if ($pf == 'quote' || $pf == 'audio' || $pf == 'link' || $pf == 'standard') {
            } else {
                // Divs for featured images thumbnail
                echo '<div class="gt3_span4">';
                echo ''.$pf_media['content'];
                echo '</div>';
                echo '<div class="gt3_span8">';
            }
            ?>
                ...
                ?>
            <?php
            // Closing div for featured images thumbnail
            if ($pf == 'quote' || $pf == 'audio' || $pf == 'link' || $pf == 'standard') {
            } else {
                echo '</div>';
            }
