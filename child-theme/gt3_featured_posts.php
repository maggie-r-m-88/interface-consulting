        ...
        <div class="vc_col-sm-12 gt3_module_featured_posts blog_alignment_<?php echo esc_attr($content_alignment) . ' ' . esc_attr($animation_class) . ' ' . esc_attr($css_class) . ' blog_' . esc_attr($view_type) . ' items' . esc_attr($items_per_line) . ' ' . esc_attr($carousel_parent) . ' class_' . esc_attr($rand_class); ?>" <?php echo(strlen($blog_style) ? 'style="' . esc_attr($blog_style) . '"' : ''); ?>>
            ...
            <?php }
                ...
                while ($gt3_wp_query_in_shortcodes->have_posts()) {
                    ...
                    if ($meta_categories == 'yes') {
                        ...
                        if (!empty($categories)) {
                            ...
                            foreach ($categories as $category) {
                                $post_category_name = $category->cat_name;
                    ...
                    // *** Custom background image code *** //

                    if ($post_category_name == 'Construction Claims'){

                        if ($view_type === 'type5') {
                        $has_post_thumb = ' has_post_thumb';
                        $gt3_background_image = 'style="background-image:url(' . '/wp-content/uploads/AdobeStock_120498612.jpeg' . ');border-radius:' . esc_attr($block_border_radius) . '"';
                        }

                    }

                    if ($post_category_name == 'Construction Advisory'){

                        if ($view_type === 'type5') {
                        $has_post_thumb = ' has_post_thumb';
                        $gt3_background_image = 'style="background-image:url(' . '/wp-content/uploads/AdobeStock_116443664.jpeg' . ');border-radius:' . esc_attr($block_border_radius) . '"';
                        }

                    }

                    if ($post_category_name == 'Construction Management'){

                        if ($view_type === 'type5') {
                        $has_post_thumb = ' has_post_thumb';
                        $gt3_background_image = 'style="background-image:url(' . '/wp-content/uploads/AdobeStock_53590862.jpeg' . ');border-radius:' . esc_attr($block_border_radius) . '"';
                        }

                    }

                    if ($post_category_name == 'Construction Litigation'){

                        if ($view_type === 'type5') {
                        $has_post_thumb = ' has_post_thumb';
                        $gt3_background_image = 'style="background-image:url(' . '/wp-content/uploads/AdobeStock_118822742.jpeg' . ');border-radius:' . esc_attr($block_border_radius) . '"';
                        }

                    }

                    if ($post_category_name == 'International Arbitration'){

                        if ($view_type === 'type5') {
                        $has_post_thumb = ' has_post_thumb';
                        $gt3_background_image = 'style="background-image:url(' . '/wp-content/uploads/AdobeStock_194578219.jpeg' . ');border-radius:' . esc_attr($block_border_radius) . '"';
                        }

                    }

                    if ($post_category_name == 'General Construction and Engineering'){

                        if ($view_type === 'type5') {
                        $has_post_thumb = ' has_post_thumb';
                        $gt3_background_image = 'style="background-image:url(' . '/wp-content/uploads/AdobeStock_157962682.jpeg' . ');border-radius:' . esc_attr($block_border_radius) . '"';
                        }
